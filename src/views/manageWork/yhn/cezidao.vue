    ...
    <div class='traceWork_step'>
        <div class='first_station'>
            <ul class='yg' @mouseleave="hideDetails(1)">
                <li v-for='(item,index) in czdData' :key='index' @mouseenter="showDetails(index,1)">
        ...
        <div class='end_station'>
            <div class='cyg'>
                ...
                <li v-for='(item,index) in lsData' :key='index' @mouseenter="showDetails(index,2)">
                      <img src="../../../assets/pic_youguan.png"/>
...
<script>
    ...
    export default {
        ...
        methods:{
          //获取该管线的信息
            getLineInfo(){
               this.axios.post("/OilTrack/czd/lineInfo").then(res=>{
                // this.czdData=res.data.rizhao[0][0].station;
                // this.lsData=res.data.yizheng[0][0].station;
